...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        # ball and character collide
        if character_rect.colliderect(ball_rect):
            running = False
            break

        # ball and weapon collide
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3:
                    ...
                    balls.append({
                        "pos_x": ball_pos_x + (small_ball_width / 2) - (small_ball_width / 2),
                        "pos_y": ball_pos_y + (small_ball_height / 2) - (small_ball_height / 2),
    ...
    # remove collided ball and weapon
    if ball_to_remove > -1:
    ...
    # end game when all balls are gone
    if len(balls) == 0:
